<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dangky.aspx.cs" Inherits="G18EShop.dangky" %>
...
<div id="dangnhap">
    ...
    <div class="right">
        <form action="dangky.aspx" id="form1" runat="server" method="POST">
            <h3>ĐĂNG KÝ</h3>
            ...
            <input name="repassword" type="password" placeholder="Nhập lại Mật khẩu"/></br>
